...
TopicName = "project_topic"
#client = KafkaClient("hadoop000:9092")
producer = KafkaProducer(bootstrap_servers=["hadoop000:9092"])
...
class Listener(StreamListener):
    ...
    def on_data(self, data):
        ...
        self.total_count += 1
        if data.get("place") and data["place"] and data["place"]["bounding_box"] and data["place"]["bounding_box"][
            "coordinates"]:
            self.geo_count += 1
            # if data.get("text"):
            #     print(data["text"])
